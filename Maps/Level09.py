...
class Level09(GameMap):
    def __init__(self,max_row,max_col,field_size):
        super().__init__(max_row, max_col, field_size,
                         ...
                         PACMAN_SPAWN_Y=field_size * 6,
                         POSSIBLE_MONSTERS=[MonsterTypes.SKULL],
                         MONSTER_SPAWN_TILES=[(1, 1)],
                         ONLOAD_SPAWN_MONSTERS=[(MonsterTypes.SKULL,(1,1)), (MonsterTypes.DEMON,(15,15))],
                         RED_DOT_POSITIONS=[(1, 7),(1, 9),(9,1),(9,15),(11,1),(12,1),(12,15),(11,15)]
                         )
    ...
    def get_image_path(self):
        return "resources/maps/Level09.png"

    def get_tiles_path(self): #sciezka gdzie jest plik tekstowy opisujacy wyglad mapy
        return "resources/maps/Level09.txt"

    def get_music_path(self):
        return "resources/music/15.MID"
